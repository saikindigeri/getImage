...
return(
     <div className="min-h-screen p-4 sm:p-6 bg-gray-100 dark:bg-gray-900 transition-colors duration-300 flex items-center justify-center relative overflow-hidden">
          {/* Background Effects */}
              ...
              {imageSrc ? (
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="absolute bottom-4 right-4 px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg font-semibold text-sm flex items-center gap-2 hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-md hover:shadow-lg active:scale-95"
                  >
